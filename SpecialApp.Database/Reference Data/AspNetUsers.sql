IF NOT EXISTS(SELECT 1 FROM [dbo].[AspNetUsers] WHERE Id = N'ece2b5ed-e306-4b4a-a785-66b2a4899cc9')
BEGIN
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[AspNetUsers] WHERE Id = N'ece2b5ed-e306-4b4a-a785-66b2a4899cc8')
BEGIN
...
INSERT INTO 
	...
	[NormalizedEmail], [NormalizedUserName], [PasswordHash], [PhoneNumber], [PhoneNumberConfirmed], [SecurityStamp], [TwoFactorEnabled], [UserName]) 
VALUES 
	(N'ece2b5ed-e306-4b4a-a785-66b2a4899cc8', 0, N'01f27daf-e116-4b49-8eb7-0376707f9155', N'bsharma2422@gmail.com',
	0, 1, NULL, N'BSHARMA2422@GMAIL.COM', N'BSHARMA2422', N'AQAAAAEAACcQAAAAENs6uE3ualdu4fVa8ID9IJW+Q3N/+tdBgOpw1Y+W0LtPgGm/kgq7CmTewFgJxC0nxQ==',
	N'0433277470', 0, N'dd575848-fc18-40d1-aa6a-a089540b2f35', 0, N'bsharma2422')
END
